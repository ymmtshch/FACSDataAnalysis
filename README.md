...
- **高度解析ページ（pages/advanced_gating.py）**: 複雑なゲーティング機能（オプション）
...
### 統計解析・エクスポート
- **包括的統計情報**: 平均値、中央値、標準偏差、最小値、最大値
- **チャンネル別統計**: 選択されたX軸・Y軸チャンネルの詳細統計
- **リアルタイム統計**: データ変換やサンプリング後の統計値をリアルタイム計算
- **多様なエクスポート**: 
  - 統計データのCSVダウンロード
